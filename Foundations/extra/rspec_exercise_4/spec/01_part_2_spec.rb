...
describe 'PART 2' do
  describe 'proper_factors' do
    it 'accepts a number as an arg' do
      expect { proper_factors(6) }.not_to raise_error
    end

    it 'returns all positive numbers less than the argument that also divide the argument' do
  ...
  describe 'aliquot_sum' do
    it 'accepts a number as an arg' do
      expect { aliquot_sum(9) }.not_to raise_error
    end

    it 'returns the sum of all proper factors of the number' do
      expect(aliquot_sum(6)).to eq(6)
      expect(aliquot_sum(12)).to eq(16)
      expect(aliquot_sum(9)).to eq(4)
    end

    it 'calls your proper_factors method' do
  ...
  describe 'perfect_number?' do
    it 'accepts a number as an arg' do
      expect { perfect_number?(6) }.not_to raise_error
    end
    ...
    it 'calls your aliquot_sum method' do
  ...
  describe 'ideal_numbers' do
    it 'accepts a number, n, as an arg' do
      expect { ideal_numbers(3) }.not_to raise_error
    end

    it 'returns an array containing the first n perfect numbers' do
