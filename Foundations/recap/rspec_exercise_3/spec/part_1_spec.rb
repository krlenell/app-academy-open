...
describe 'PART 1' do
  describe 'is_prime?' do
    it 'accepts a number as an arg' do
      expect { is_prime?(7) }.not_to raise_error
    end
  ...
  describe 'nth_prime' do
    it 'accepts a number, n, as an arg' do
      expect { nth_prime(5) }.not_to raise_error
    end

    it 'returns the nth prime number sequentially' do
  ...
  describe 'prime_range' do
    it 'accepts two numbers, min and max, as args' do
      expect { prime_range(4, 17) }.not_to raise_error
    end

    it 'returns an array of all prime numbers between min and max' do
