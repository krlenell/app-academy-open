...
describe 'GuessingGame' do
  ...
  describe '#initialize' do
    it 'accepts two numbers, min and max, as args' do
      guessing_game
    end

    it 'sets @secret_num to a random number between min and max inclusive' do
  ...
  describe '#check_num' do
    ...
    it 'sets @game_over to true if the num is equal to @secret_num' do
  ...
  describe 'ask_user' do
    ...
    it 'calls String#to_i on the input string to convert it into an integer number' do
    ...
    it "calls GuessingGame#check_num with the user's number" do
      allow(guessing_game).to receive(:gets).and_return("50\n")
